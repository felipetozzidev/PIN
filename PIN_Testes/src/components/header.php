            ...
            <div class="col-4 navbar-nav d-flex justify-content-center d-none d-md-flex">
                <div class="search col-12">
                    <form class="d-flex" role="search" action="index.php" method="GET">
                        ...
                        <input class="me-2" type="search" name="search" placeholder="Buscar..." aria-label="Search" value="<?php echo $search_query ?>">
                    </form>
                </div>
            </div>
            <div class="col-4 actions navbar-nav justify-content-end">
                <a class="nav-item d-none d-md-block me-2" href="post.php">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                            <li class="dropdown-item-text">
                                <?php if (isset($_SESSION['nome_usu'])): ?>
                                    <?php
                                    $nomeCompleto = $_SESSION['nome_usu'];
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body">
            ...
            <div class="actions navbar-nav col-12 justify-content-end mt-3">
                <a class="nav-item d-block d-md-none me-2" href="post.php">
                    <img src="../src/assets/icons/add-large-line.svg" alt="" width="35px">
                </a>
